...
export default function TrackSplitSection() {
  return (
    <section id="track" className="relative min-h-screen bg-vk-light">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-end p-12 md:p-16 z-20">
            ...
            <motion.button
              ...
              className="group/btn bg-vk-red hover:bg-vk-red/90 text-vk-text-dark font-bold h-16 px-6 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 shadow-2xl overflow-hidden"
            >
