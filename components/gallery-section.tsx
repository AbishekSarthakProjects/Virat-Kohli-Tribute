...
function MasonryItem({ item, index }: { item: any; index: number }) {
  ...
  return (
    ...
    >
      {item.type === "quote" && (
        <div className="bg-vk-red text-vk-text-dark p-10 rounded-2xl border-4 border-vk-red h-full flex flex-col items-center justify-center shadow-2xl">
      ...
      {item.type === "text" && (
        <div className="bg-vk-light/5 border-2 border-vk-light/20 p-8 rounded-2xl h-full flex items-center justify-center shadow-xl">
...
export default function GallerySection() {
  return (
    <section id="gallery" className="relative min-h-screen bg-vk-black text-vk-text-light py-24 px-6 md:px-12">
